        ...
        return(
            ...
            <Form>
                ...
                <Form.Group controlName="forNameGroup  ">
                    ...
                    <Form.Control type="Name" placeholder="Enter Name" disabled/>
                </Form.Group>
               
                <Form.Group >
                    <Form.Label>ID group</Form.Label>
                    <Form.Control type="group" placeholder="Enter Id Group" disabled/>
                </Form.Group>
                ...
                <Form.Label>Choose the branch that belongs</Form.Label>
                    <select name="Branch" class="custom-select" disabled>
                        <option selected>Cargar de la base de datos</option>
