...
class Assign_lider_to_a_branch extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            people:[], 
    ...
    agregarPersona= (id) =>{
        try{
            axios.post('https://backend-proyi.herokuapp.com/branch/addBoss', { name:this.state.branch , id })
             .then(response => {
    ...
    render(){
        const { people,checked ,zones , movements , branches} = this.state
        ...
        return(
            ...
            <Form>  
                ...
                <div className="container">
                    <h2>Select maximum two leaders for the branch</h2>
...
export default Assign_lider_to_a_branch;