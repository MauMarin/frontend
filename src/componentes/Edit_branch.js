...
class Edit_branch extends React.Component{
    render(){
        return(
            ...
            <Form>
                ...
                <h1>Edit details of branch:</h1>
                <hr color='white'></hr>
                <Form.Group controlName="forNameBranch">
                    <Form.Label>Name branch</Form.Label>
                    <Form.Control type="Branch" placeholder="Enter Name" />
                </Form.Group>

                <Form.Group >
                    <Form.Label>ID Branch</Form.Label>
                    <Form.Control type="Branch" placeholder="Enter Id Branch" />
                </Form.Group>
