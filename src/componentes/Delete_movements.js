...
class Delete_movements extends React.Component{
        ...
        return(
            ...
            <Form>
                ...
                <Form.Group controlName="forIDMovement">
                    ...
                    <Form.Control type="Movement" placeholder="Datos cargados" disabled/>
                </Form.Group>
                

                <Form.Group controlId="formWebsite">
                    <Form.Label>Website</Form.Label>
                    <Form.Control type="Website" placeholder="Datos cargados" disabled/>
                </Form.Group>
            
                <Form.Group controlId="formCountry">
                <Form.Label>Country</Form.Label>
                    <select name="Country" class="custom-select" disabled>
                ...
                <input type = "file" onChange={this.fileSelectedHandler} disabled/>
...
export default Delete_movements;
