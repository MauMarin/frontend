...
class Delete_zone extends React.Component{
    render(){
        return(
            ...
            <Form>
                ...
                <Form.Group controlName="forNameZone">
                    ...
                    <Form.Control type="Zone" placeholder="Enter Name" disabled />
                </Form.Group>

                <Form.Group >
                    <Form.Label>ID Zone</Form.Label>
                    <Form.Control type="Zone" placeholder="Enter Id Zone"  disabled/>
                </Form.Group>
