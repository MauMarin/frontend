...
class Assign_lider_to_a_zone extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            people:[], 
    ...
    agregarPersona= (id) =>{
        try{
            axios.post('https://backend-proyi.herokuapp.com/zone/addBoss', { name:this.state.zone , id })
             .then(response => {
    ...
    render(){
        const { people,checked ,zones , movements} = this.state
        ...
        return(
            ...
            <Form>  
                ...
                <div className="container">
                    <h2>Select maximum two leaders for the zone</h2>
...
export default Assign_lider_to_a_zone;
